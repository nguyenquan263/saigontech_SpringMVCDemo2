...
public class studentController {
	...
	public String goSave(HttpServletRequest req) {
		...
		return "redirect:/Student?notification=Adding successfully!";
	}
	...
	public String goDelete(HttpServletRequest req) {
		...
		return "redirect:/Student?notification=Removing successfully!";
	}
	...
	public String goConfirm(HttpServletRequest req) {
		...
		return "redirect:/Student?notification=Updating successfully!";
	}
}